          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>View Requests <small></small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      <thead>
                        <tr><th>ID</th><th>Service Request No</th><th>Customer Name</th><th>Ticket Status</th><th>Action</th></tr>
                      </thead>


                      <tbody>
                       <c:forEach items="${list}" var="userList">
  <tr><td>${userList.id}</td><td>${userList.service_no}</td><td>${userList.customername }</td>
  <td>
    <c:if test="${userList.ticketStatus eq 'pending'}">  
    <span class="btn btn-danger">Pending</span>  
    </c:if> 
    <c:if test="${userList.ticketStatus eq 'approved'}">  
    <span class="btn btn-success">Approved</span>  
    </c:if> 
    <c:if test="${userList.ticketStatus eq 'rejected'}">  
    <span class="btn btn-danger">Rejected</span>  
    </c:if>
    <c:if test="${userList.ticketStatus eq 'completed'}">  
    <span class="btn btn-success">Completed</span>  
    </c:if> 
  </td>
  <td>
  <a href="${pageContext.request.contextPath}/admin/admincreatecustomer/${userList.id}" class="btn btn-danger">Action</a></td></tr>
  </c:forEach>
                      </tbody>
                    </table>
                  </div>
