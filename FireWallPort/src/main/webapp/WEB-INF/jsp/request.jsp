              ...
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form action="${pageContext.request.contextPath}/employee/requestlist" method="post">
<div class="form-group" >
						<select name="customername" class="form-control" style="margin-top:50px;width:500px;">
