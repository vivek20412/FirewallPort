            ...
            <div class="clearfix"></div>
           	...
           	<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								<div class="x_title">
									<h2>Customer ! <small>Add New Customer</small></h2>
								...
								<div class="x_content">
									...
									<form:form action="${pageContext.request.contextPath}/dcteam/saveDetails" modelAttribute="customer"  class="form-horizontal form-label-left">
...
<span style="color:green;font-weight:bold;"></span>
					...
					<div class="alert alert-success"
				     ...
				     <input type="hidden" name="id" value="${customerDetails.id}" />
						...
						placeholder="Customer Name" required="required"  id="customername" path="customername" value="${customerDetails.customername }" class="form-control" />
							...
							class="form-control" placeholder="Mobile Number" id="mob" path="mob" value="${customerDetails.mob }"/>
							...
							<a id="add" class="btn btn-round btn-info" style="color: white;">Add</a><a id="remove" onclick="removeRow()" style="color: white;" class="btn btn-round btn-danger">Remove</a>	
                      ...
                      <tr>
					<td></td>
					<td><c:forEach items="${customerDetails.serverDetails}" var="l"><input class='TF' type='text' placeholder='Host Name' name='hostname' value="${l.hostname}"/></c:forEach></td>
					<td><c:forEach items="${customerDetails.serverDetails}" var="l"><input class='TF' type='text' placeholder='Host Name' name='hostname' value="${l.os}"/></c:forEach></td>
					<td><c:forEach items="${customerDetails.serverDetails}" var="l"><input class='TF' type='text' placeholder='Host Name' name='hostname' value="${l.privateip}"/></c:forEach></td>
					</tr>
                      

					<tr><td></td><td><input  type='text' placeholder='Host Name' name='hostname' /></td>
					<td>
					<select name='os'>
					...
					</select></td><td><input  type='text' placeholder='Private IP' name='privateip' /></td></tr>
					<tr>
