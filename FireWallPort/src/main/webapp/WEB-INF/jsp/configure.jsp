						...
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									...
									<form:form action="${pageContext.request.contextPath}/employee/saveConfiguration" modelAttribute="customer"  class="form-horizontal form-label-left">
...
<span style="color:green;font-weight:bold;"></span>
					...
					<div class="alert alert-success"
				     ...
				     <input type="hidden" name="username"
							value="${customerDetails.username_cust_details}" />
							<input type="hidden" name="id" value="${customerDetails.id}" readonly="true" />
										...
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Service Request Number: <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
											
											
							                     <form:input type="text" class="form-control"
								                    placeholder="Service Request Number" id="service_no"
								                    path="service_no" value="${customerDetails.service_no }"
								                         readonly="true" />
							                           <form:errors path="customername" cssClass="error" />
										...
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Mobile Number <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
											
											
							                     <form:input type="number" class="form-control"
								                            placeholder="Mobile Number" id="mob" path="mob"
								                              value="${customerDetails.mob }" readonly="true" />
								...
								placeholder="E-Mail" id="email" path="email"
								value="${customerDetails.email }" readonly="true" />
							...
							<tr>
							<td><c:forEach
									items="${customerDetails.serverDetailsForTicket}" var="l"> ${l.hostname}</c:forEach></td>
							<td><c:forEach
									items="${customerDetails.serverDetailsForTicket}" var="l">${l.os} </c:forEach></td>
							<td><c:forEach
									items="${customerDetails.serverDetailsForTicket}" var="l"> ${l.privateip}</c:forEach></td>
							<td><c:forEach
									items="${customerDetails.serverDetailsForTicket}" var="l">${l.publicip}</c:forEach></td>
							<td><c:forEach
									items="${customerDetails.serverDetailsForTicket}" var="l">${l.nat}</c:forEach></td>
							</tr>
							</tbody>
							</table>
							...
							<tbody>
								<tr>
									<td>${l.id }</td>
									<td>${l.action }</td>
									<td>${l.activationTime }</td>
									<td>${l.deactivationTime }</td>
									<td>${l.direction }</td>
									<td>${l.ipentry }</td>
									<td>${l.sourceIp }</td>
									<td>${l.port }</td>
									<td >${l.comments }test</td>
								</tr>
								
							</c:forEach>
							<tr><th colspan="4">Admin Comment</th><td colspan="5">${customerDetails.adminComment }</td></tr>
						</tbody>
						</table>
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Configuration Description: <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
											
											
							                     <form:input class="form-control"
								placeholder="Configuration Description" id="configurationDesc"
								path="configurationDesc"
								value="${customerDetails.configurationDesc }" />
							<form:errors path="customername" cssClass="error" />
